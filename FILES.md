...
- `app/dashboard/page.tsx`: Dashboard overview with demo metrics, getting started checklist, and activity feed.
...
- `/dashboard` → `app/dashboard/layout.tsx` + `app/dashboard/page.tsx`
  ...
  - Purpose: dashboard overview with demo metric cards, getting started checklist, and recent activity feed.
...
app/
  ...
  dashboard/
    ...
    page.tsx               # Dashboard overview (metrics, onboarding, activity)
    settings/
...
components/
  dashboard/
    ...
    dashboard-content.tsx  # Client dashboard overview (metrics, charts, search, activity)
...
.github/
  workflows/
    init-db.yml            # GitHub Actions DB init workflow (disabled)
```
