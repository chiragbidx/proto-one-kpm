...
components/
  dashboard/
    ...
    dashboard-content.tsx   # Client dashboard overview (metrics, charts, search)
...
- shadcn/ui primitives are pre-bundled in `components/ui/` (accordion, alert-dialog, avatar, badge, button, card, carousel, collapsible, form, icon, input, label, navigation-menu, popover, scroll-area, select, separator, sheet, textarea).
